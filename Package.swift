...
let package = Package(
    ...
    targets: [
        ...
        // --- zk-cred-bbs UniFFI bindings (XCFramework) ---
        // Built by `make xcframework` in the zk-cred-bbs crate. Same naming
        // convention as the two above: crate name + "FFI". Its headers are
        // nested under zk_cred_bbsFFI/ inside the XCFramework precisely so
        // that linking it alongside those two does not collide on a shared
        ...
        .binaryTarget(
            ...
            url: "https://github.com/sirosfoundation/siros-dc-matcher/releases/download/v0.6.2/siros_dc_matcher_ffi.xcframework.zip",
        ...
        .target(
            ...
            dependencies: [
                ...
                // Same story, same gate: zk_cred_bbsFFI ships iOS slices
                // only, and BbsProofSystem.swift plus
        ...
        .testTarget(
            ...
            // The BBS fixture, generated by `make sdk-fixture` in the
            // zk-cred-bbs crate and read through `Bundle.module`.
        ...
        .binaryTarget(
            ...
            url: "https://github.com/sirosfoundation/siros-wscd-manager/releases/download/v0.8.1/siros_wscd_manager.xcframework.zip",
            checksum: "ca2e83eab955a6ca4f22d7107f0b8c92320da9263b19cd8f7c3817af82c37870"
        ),

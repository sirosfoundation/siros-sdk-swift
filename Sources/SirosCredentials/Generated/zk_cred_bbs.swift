...
// zk_cred_bbsFFI's XCFramework only ships iOS slices - same gate, and same
// reason, as zk_cred_longfellow.swift and siros_wscd_manager.swift. Without
// it every non-iOS build of this module fails to link.
#if os(iOS)
